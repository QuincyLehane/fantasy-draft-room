...
const sleeperProfiles: Record<string, [number, number, string?]> = {
  ...
  "Kyren Williams": [25,4], "Tetairoa McMillan": [23,1], "Tee Higgins": [27,6],
  ...
  "Josh Jacobs": [28,7,"Questionable"], "Jaylen Waddle": [27,5], "Garrett Wilson": [26,4],
  ...
  "Bhayshul Tuten": [23,1], "TreVeyon Henderson": [23,1,"Questionable"], "Jadarian Price": [22,0],
  ...
  "Chuba Hubbard": [27,5,"Questionable"], "Alec Pierce": [26,4,"Questionable"], "Jonathon Brooks": [23,2],
  ...
  "Jordyn Tyson": [22,0,"Doubtful"], "Jaxson Dart": [23,1], "Blake Corum": [25,2], "RJ Harvey": [25,1],
  ...
  "De'Zhaun Stribling": [23,0], "C.J. Stroud": [24,3], "Keaton Mitchell": [24,3,"Questionable"],
  "Tank Bigsby": [23,3], "Brenton Strange": [25,3], "Rashid Shaheed": [27,4], "Chig Okonkwo": [26,4],
  "Hunter Henry": [31,10], "Isiah Pacheco": [27,4,"Questionable"], "Brian Robinson Jr.": [27,4],
  ...
  "Cameron Dicker": [26,4], "Cam Little": [23,2], "Jason Myers": [35,11], "Eddy Pineiro": [30,8],
